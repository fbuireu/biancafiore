...
const BlogJumbotron = ({
  ...
  blog: {
    title: blogTitle,
    jumbotron: {
      featuredArticle: { cta: latestFeaturedArticleCta },
      socialNetworks: { cta: socialNetworkCta, socialNetworks },
    },
  },
      ...
      <div className={`blog__jumbotron__inner`}>
        ...
        >
          <div className={`blog__jumbotron__latest-featured-article__header`}>
            <p
              className={`blog__jumbotron__latest-featured-article__reading-time`}
            >
              {readingTime}min
            </p>
            <ul
          ...
          <h2 className={`blog__jumbotron__latest-featured-article__title`}>
            {latestFeaturedArticleTitle}
          </h2>
          <Link
            className={`blog__jumbotron__latest-featured-article__author`}
            to={`/tags/${slugify(author)}`}
          >
            {author}
          </Link>
          <time
            className={`blog__jumbotron__latest-featured-article__date`}
          ...
          <Link
            to={`/blog${slug}`}
            className={`blog__jumbotron__latest-featured-article__cta`}
          >
            {latestFeaturedArticleCta}
          </Link>
        </div>
        <div className={`blog__jumbotron__latest-featured-article__share`}>
          <p
            className={`blog__jumbotron__latest-featured-article__share__title`}
          >
            {socialNetworkCta}
          </p>
          <ul
