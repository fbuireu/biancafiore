...
const Filter = ({ filterParameters, defaultRefinement, hasRange, queryStringCriteria }) => {
  return <aside className={`filters__wrapper`}>
    <Search />
    <SortHitsBy defaultRefinement={defaultRefinement} items={filterParameters.SORT_BY} />
