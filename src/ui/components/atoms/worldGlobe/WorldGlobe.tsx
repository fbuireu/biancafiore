            ...
            <div className="world-globe__controls flex row-wrap justify-center">
                <div className="world-globe__controls__direction-wrapper flex row-wrap">
                    <button
                        ...
                        onClick={() =>
                            handleAction({ movementDirection: Direction.CLOCKWISE, type: MovementType.MOVE })
                        }
                    >
                    ...
                    <button
                        ...
                        onClick={() =>
                            handleAction({ movementDirection: Direction.COUNTERCLOCKWISE, type: MovementType.MOVE })
                        }
                    >
